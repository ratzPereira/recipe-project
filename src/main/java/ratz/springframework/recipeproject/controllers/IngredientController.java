...
public class IngredientController {
    ...
    public String showRecipeIngredient(@PathVariable String recipeId, @PathVariable String id,
        ...
        model.addAttribute("ingredient", ingredientService.findByRecipeIdAndIngredientId(Integer.valueOf(recipeId),
                Integer.valueOf(id)));
    ...
    public String deleteIngredient(@PathVariable String recipeId,
       ...
       ingredientService.deleteById(Integer.valueOf(recipeId), Integer.valueOf(id));
